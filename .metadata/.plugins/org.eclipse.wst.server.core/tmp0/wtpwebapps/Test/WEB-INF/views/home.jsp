		...
		<tbody>
			<c:forEach items="${screenInfo}" var="item" varStatus="status">
				<tr class="table-active">
				    <td class = "text-center" style = "width:10%; height:240px;" id ="count">${status.count}</td>
				    ...
				    <td>
				    出発地
				     <img alt="" src="resources/image/yazirusi.png" width="20">
				     <img alt="" src="resources/image/walk.png" width="20">徒歩 : <c:out value="${item.startWalkTime}" />分 <c:out value="${item.startWalkDistance}" />
				     <img alt="" src="resources/image/yazirusi.png" width="20"><c:out value="${item.stations}" />
				     <img alt="" src="resources/image/yazirusi.png" width="20">
				     <img alt="" src="resources/image/walk.png" width="20">徒歩 : <c:out value="${item.endWalkTime}" />分 <c:out value="${item.endWalkDistance}" />
				     <img alt="" src="resources/image/yazirusi.png" width="20">
				    到着地
				    </td>
				    </tr>
				    ...
				    <td class = "text-center" style = "width:20%; height:240px">
				    <c:out value="${item.fare}" /><br>
				    <c:out value="${item.oneWayFare}" />
				    </td>
				</tr>
			</c:forEach>
		</tbody>
